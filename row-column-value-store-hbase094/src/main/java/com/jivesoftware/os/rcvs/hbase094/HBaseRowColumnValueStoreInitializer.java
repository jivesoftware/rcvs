...
public class HBaseRowColumnValueStoreInitializer implements RowColumnValueStoreInitializer<Exception> {
    ...
    static public interface HBase094RowColumnValueStoreConfig extends Config {
    ...
    public HBaseRowColumnValueStoreInitializer(HBase094RowColumnValueStoreConfig config) {
        this(config, defaultHbaseConfig(config));
    }

    public HBaseRowColumnValueStoreInitializer(HBase094RowColumnValueStoreConfig config, org.apache.hadoop.conf.Configuration hbaseConfig) {
        this.hbaseConfig = hbaseConfig;
        this.marshalExecutor = Executors.newFixedThreadPool(config.getMarshalThreadPoolSize());
    }

    private static org.apache.hadoop.conf.Configuration defaultHbaseConfig(HBase094RowColumnValueStoreConfig config) {
