...
public class MasterSlaveHARowColumnValueStore<T, R, C, V, E extends Exception> implements RowColumnValueStore<T, R, C, V, E> {
    ...
    public MasterSlaveHARowColumnValueStore(RowColumnValueStore<T, R, C, V, E> master,
        ReadFailureMode readFailureMode,
        RowColumnValueStore<T, R, C, V, E> slave) {
        this.master = master;
