 ...
 * @author jonathan
 */
public class HBaseRowColumnValueStore<T, R, C, V> implements RowColumnValueStore<T, R, C, V, Exception> {
     ...
     *
     * @param connection      cannot be null
    ...
    public void multiAdd(final T tenantId, final R rowKey, final C[] columnKeys, final V[] columnValues,
        ...
        HTableInterface t = connection.getTable(table);
        try {
